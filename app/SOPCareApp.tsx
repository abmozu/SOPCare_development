...
function InjuryDetailView({ injury, rehabilitationPlan, history, encounters, onBack, onAthlete, onEncounter, onStage, onRehabilitation, onCreateRehabilitation }: { injury: Injury; rehabilitationPlan?: RehabilitationPlan; history: InjuryHistory[]; encounters: Encounter[]; onBack: () => void; onAthlete: (id: string) => void; onEncounter: (encounter: Encounter) => void; onStage: () => void; onRehabilitation: (id: string) => void; onCreateRehabilitation: () => void }) {
