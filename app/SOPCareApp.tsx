      ...
      <div className="medical-file-body">
        <div className="medical-record-stage">
          ...
          <div className="medical-file-workspace medical-file-two-column">
            ...
            <main className="consultation-panel">{selectedEncounter && selectedAthlete ? <><div className="medical-column-head"><div><span className="section-kicker">Visit review</span><h3>{selectedEncounter.encounterType}</h3></div><button className="button secondary small pdf-button" onClick={() => window.print()}>↓ Download PDF</button></div><div className="consultation-scroll" key={selectedEncounter.id}><VisitReviewEditor encounter={selectedEncounter} onSave={onSave} /></div></> : <div className="medical-empty large"><span>≡</span><strong>Select an encounter</strong><p>The visit review will appear here.</p></div>}</main>
          </div>
        </div>
      </div>
    </section>
